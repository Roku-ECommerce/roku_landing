...
function deriveFontSettings(fallbackFamily, fallbackWeight, fallbackSizePx) {
...
export default function DottedBackground({
    ...
    const glyphTextureRef = useRef(null);
    const glyphGridRef = useRef(null);
    const dummyGlyphTextureRef = useRef(null);
